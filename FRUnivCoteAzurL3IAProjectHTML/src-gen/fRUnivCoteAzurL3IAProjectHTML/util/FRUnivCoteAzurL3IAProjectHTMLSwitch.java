 ...
 * @generated
 */
public class FRUnivCoteAzurL3IAProjectHTMLSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FRUnivCoteAzurL3IAProjectHTMLSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case FRUnivCoteAzurL3IAProjectHTMLPackage.FILE_LOADER: {
			FileLoader fileLoader = (FileLoader) theEObject;
			T result = caseFileLoader(fileLoader);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseFileLoader(FileLoader object) {
		return null;
	}
...
} //FRUnivCoteAzurL3IAProjectHTMLSwitch
