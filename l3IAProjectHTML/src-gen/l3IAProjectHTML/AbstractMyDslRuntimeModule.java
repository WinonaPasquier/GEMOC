...
import l3IAProjectHTML.formatting2.MyDslFormatter;
import l3IAProjectHTML.generator.MyDslGenerator;
import l3IAProjectHTML.parser.antlr.MyDslAntlrTokenFileProvider;
import l3IAProjectHTML.parser.antlr.MyDslParser;
import l3IAProjectHTML.parser.antlr.internal.InternalMyDslLexer;
import l3IAProjectHTML.scoping.MyDslScopeProvider;
import l3IAProjectHTML.serializer.MyDslSemanticSequencer;
import l3IAProjectHTML.serializer.MyDslSyntacticSequencer;
import l3IAProjectHTML.services.MyDslGrammarAccess;
import l3IAProjectHTML.validation.MyDslConfigurableIssueCodesProvider;
import l3IAProjectHTML.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "l3IAProjectHTML/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("l3IAProjectHTML.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("projectHTML");
	}
